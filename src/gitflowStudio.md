# GitFlow Studio — Product Idea & Plan
...
**GitFlow Studio** — расширение для VS Code / Cursor с визуальным интерфейсом для управления git worktrees, заточенное под параллельную работу с AI-агентами.
...
| **GitFlow Studio** | **Webview Dashboard** | **Full pipeline** | **Per-worktree AI** | **Visual cleanup** |
